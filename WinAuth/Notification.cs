...
namespace WinAuth
{
    public partial class Notification : MetroForm
    {
            ...
            NotificationAnimation animation = null)
        {
            ...
            if (animation == null) animation = new NotificationAnimation();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (button != null && button.OnPressed != null) button.OnPressed(this);
        }
        ...
        private class FormAnimator
        {
            ...
            ///     specified
            /// </remarks>
            public FormAnimator(Form form, AnimationMethod method, AnimationDirection direction, int duration) : this(
        ...
        private void Notification_Load(object sender, EventArgs e)
        {
            ...
            foreach (var openForm in openNotifications) openForm.Top -= Height;
        ...
        private void Notification_Click(object sender, EventArgs e)
        {
            ...
            if (OnNotificationClicked != null) OnNotificationClicked(this, e);
        }
