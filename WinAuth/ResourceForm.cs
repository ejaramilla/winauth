...
namespace WinAuth
{
    ...
    public class ResourceForm : MetroForm
    {
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            var text = WinAuthMain.StringResources.GetString(formname, Thread.CurrentThread.CurrentCulture);
        ...
        private List<Control> GetControls(Control control, Type[] controlTypes = null, List<Control> controls = null)
        {
            ...
            {
                if (controlTypes == null || controlTypes.Contains(c.GetType(), baseComparer)) controls.Add(c);
                if (c.Controls != null && c.Controls.Count != 0) GetControls(c, controlTypes, controls);
            }
