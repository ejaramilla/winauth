...
namespace WinAuth
{
    ...
    public class SecretTextBox : TextBox, ISecretTextBox
    {
        ...
        public override string Text
        {
            ...
            {
                m_text = value;
                base.Text = SecretMode
                    ? string.IsNullOrEmpty(value) == false ? new string('*', value.Length) : value
                    : value;
                Invalidate();
            }
        }
        ...
        public bool SecretMode
        {
            ...
            set
            {
                ...
                if (value == false) Font = new Font(m_fontFamily, m_fontSize);
                //
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            using (Brush brush = new SolidBrush(base.ForeColor))
            {
                ...
                g.DrawString(text != null ? text : string.Empty, base.Font, brush, new RectangleF(0, 0, Width, Height),
                    sf);
            }
        }
    }
