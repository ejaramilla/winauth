...
namespace WinAuth
{
    ...
    public partial class ExportForm : ResourceForm
    {
        ...
        {
            if (passwordCheckbox.Checked) pgpCheckbox.Checked = false;
        ...
        {
            if (pgpCheckbox.Checked) passwordCheckbox.Checked = false;

            pgpField.Enabled = pgpCheckbox.Checked;
            if (pgpCheckbox.Checked) pgpField.Focus();
        }
        ...
        private void browseButton_Click(object sender, EventArgs e)
        {
            ...
            if (sfd.ShowDialog(Parent) != DialogResult.OK) return;
        ...
        private void okButton_Click(object sender, EventArgs e)
        {
            ...
            if (passwordCheckbox.Checked && passwordField.Text.Length != 0) Password = passwordField.Text;
            if (pgpCheckbox.Checked && pgpField.Text.Length != 0) PGPKey = pgpField.Text;
        }
    }
}