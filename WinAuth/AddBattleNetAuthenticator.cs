    ...
    public partial class AddBattleNetAuthenticator : ResourceForm
    {
        ...
        private void newAuthenticatorTimer_Tick(object sender, EventArgs e)
        {
            if (Authenticator.AuthenticatorData != null && newAuthenticatorProgress.Visible)
            {
                ...
                if (time == 0) newLoginCodeField.Text = Authenticator.AuthenticatorData.CurrentCode;
            }
        }
        ...
        {
            if (verifyAuthenticator() == false) DialogResult = DialogResult.None;
        }
            ...
            else if (tabControl1.SelectedIndex == 2)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (string.IsNullOrEmpty(authenticator.Serial)) authenticator.Serial = "US-Imported";
                    }
                ...
                {
                    WinAuthForm.ErrorDialog(Owner,
                        "Unable to import the authenticator. The private key is probably invalid.", irre);
                    return false;
                }
            }
        ...
        private void enrollAuthenticatorButton_Click(object sender, EventArgs e)
        {
            do
            {
                ...
                {
                    if (WinAuthForm.ErrorDialog(Owner, "An error occured while registering a new authenticator", iere,
