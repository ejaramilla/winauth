...
namespace WinAuth
{
    ...
    public class WinAuthConfig : IList<WinAuthAuthenticator>, ICloneable, IWinAuthAuthenticatorChangedListener
    {
        ...
        public static decimal CURRENTVERSION =
            decimal.Parse(Assembly.GetExecutingAssembly().GetName().Version.ToString(2), CultureInfo.InvariantCulture);
        ...
        public Authenticator.PasswordTypes PasswordType
        {
            ...
            set
            {
                ...
                if ((_passwordType & Authenticator.PasswordTypes.Explicit) == 0) Password = null;
            }
        }
        ...
        {
            if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("Authenticator", sender, e));
        }
        ...
        public bool AlwaysOnTop
        {
            ...
            {
                _alwaysOnTop = value;
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("AlwaysOnTop"));
            }
        }
        ...
        public bool UseTrayIcon
        {
            ...
            {
                _useTrayIcon = value;
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("UseTrayIcon"));
            }
        }
        ...
        public NotifyActions NotifyAction
        {
            ...
            {
                _notifyAction = value;
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("NotifyAction"));
            }
        }
        ...
        public bool StartWithWindows
        {
            ...
            set
            {
                ...
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("StartWithWindows"));
            }
        }
        ...
        public bool AutoSize
        {
            ...
            {
                _autoSize = value;
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("AutoSize"));
            }
        }
        ...
        public Point Position
        {
            ...
            set
            {
                ...
                {
                    _position = value;
                    if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("Position"));
                }
            }
        }
        ...
        public int Width
        {
            ...
            set
            {
                ...
                {
                    _width = value;
                    if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("Width"));
                }
            }
        }
        ...
        public int Height
        {
            ...
            set
            {
                ...
                {
                    _height = value;
                    if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("Height"));
                }
            }
        }
        ...
        public string ShadowType
        {
            ...
            {
                _shadowType = value;
                if (OnConfigChanged != null) OnConfigChanged(this, new ConfigChangedEventArgs("ShadowType"));
            }
        }
        ...
        public bool IsPortable =>
            ...
            && string.Compare(Path.GetDirectoryName(Filename),
                Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), true) == 0;
        ...
        public void WriteSetting(string name, string value)
        {
            if (IsPortable)
            {
                if (value == null)
                {
                    if (_settings.ContainsKey(name)) _settings.Remove(name);
                }
                else
                {
        ...
        {
            var count = Count;
            for (var i = 0; i < count; i++) this[i].Index = i;
        }
        ...
        public object Clone()
        {
            ...
            foreach (var wa in _authenticators) clone._authenticators.Add(wa.Clone() as WinAuthAuthenticator);
            clone.CurrentAuthenticator = CurrentAuthenticator != null
                ? clone._authenticators[_authenticators.IndexOf(CurrentAuthenticator)]
                : null;
            return clone;
        }
        ...
        public bool ReadXml(XmlReader reader, string password = null)
        {
            ...
            reader.Read();
            while (reader.EOF == false && reader.IsEmptyElement) reader.Read();
        ...
        protected bool ReadXmlInternal(XmlReader reader, string password = null)
        {
            ...
            decimal version;
            if (decimal.TryParse(reader.GetAttribute("version"), NumberStyles.Any, CultureInfo.InvariantCulture,
                out version))
            {
                Version = version;
                ...
                if (reader.IsStartElement())
                {
                    switch (reader.Name)
                    {
                        ...
                        case "settings":
                            ...
                            _settings = ((setting[]) serializer.Deserialize(reader)).ToDictionary(e => e.Key,
                                e => e.Value);
                            break;
                        ...
                        case "WinAuthAuthenticator":
                            ...
                            Add(wa);
                            if (CurrentAuthenticator == null) CurrentAuthenticator = wa;
                            break;
                        ...
                        case "authenticator":
                            ...
                            if (waold.AuthenticatorData is BattleNetAuthenticator) waold.Name = "Battle.net";
                            Add(waold);
        ...
        public void WriteXmlString(XmlWriter writer, bool includeFilename = false, bool includeSettings = true)
        {
            ...
            //
            if (includeFilename && string.IsNullOrEmpty(Filename) == false) writer.WriteComment(Filename);
            //
            ...
            if (PasswordType != Authenticator.PasswordTypes.None)
            {
                ...
                if ((PasswordType & Authenticator.PasswordTypes.Explicit) != 0) encryptedTypes.Append("y");
                if ((PasswordType & Authenticator.PasswordTypes.User) != 0) encryptedTypes.Append("u");
                if ((PasswordType & Authenticator.PasswordTypes.Machine) != 0) encryptedTypes.Append("m");
                ...
                using (var ms = new MemoryStream())
                {
                    ...
                    using (var encryptedwriter = XmlWriter.Create(ms, settings))
                    {
                        ...
                        foreach (var wa in this) wa.WriteXmlString(encryptedwriter);
                ...
                {
                    var encdata = Authenticator.EncryptSequence(Authenticator.ByteArrayToString(data), PasswordType,
                        Password);
                    var enchash =
            ...
            {
                foreach (var wa in this) wa.WriteXmlString(writer);
            }
            ...
            if (includeSettings && _settings.Count != 0)
            {
                ...
                serializer.Serialize(writer,
                    _settings.Select(e => new setting {Key = e.Key, Value = e.Value}).ToArray(), ns);
            }
    ...
    public class ConfigChangedEventArgs : EventArgs
    {
        ...
        public ConfigChangedEventArgs(string propertyName, WinAuthAuthenticator authenticator = null,
            WinAuthAuthenticatorChangedEventArgs acargs = null)
        {
        ...
        public WinAuthAuthenticatorChangedEventArgs AuthenticatorChangedEventArgs { get; }
    }
